            ...
            <div class="container manage-menu-container bgContent bg-light p-4">
                <div class="register-form">
                    <div class="card-header">
                        <h3 style="text-align: center">Update Food Details</h3>
                    </div>
                    <jsp:useBean id="food" scope="request" class="com.RERES.model.Food" />
                    <form action="ManageFoodServlet" method="POST" class="mt-3">
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <label for="foodName">Food name:</label>
                                    <input type="text" class="form-control form-control-lg" placeholder="Enter food name" name="foodName" id="foodName" value='<jsp:getProperty name="food" property="foodName"/>' required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3 input-group-lg">
                                        ...
                                        <input type="number" class="form-control" placeholder="" name="foodPrice" id="foodPrice" min="0" value='<jsp:getProperty name="food" property="foodPrice"/>' step="0.01" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="foodDescription">Food description:</label>
                                    <input type="text" class="form-control form-control-lg" placeholder="Enter food description" name="foodDescription" id="foodDescription" value='<jsp:getProperty name="food" property="foodDescription"/>' required>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-lg" placeholder="Enter food category" name="foodCategory" id="foodCategory" required>
                                        <option value="<jsp:getProperty name="food" property="foodCategory"/>"><jsp:getProperty name="food" property="foodCategory"/></option>
                            ...
                            <div class="col">
                                ...
                                <div class="form-group" style="display:block;margin-right:auto;margin-left:auto;width: 90%;">
                                    <img id="profilePicture" src='ManageFoodServlet?action=getFoodImage&foodID=<jsp:getProperty name="food" property="foodID"/>' alt="profile picture" class="mx-auto d-block custom-shadow mb-3" width="200" height="200" style="border-radius: 50%;">
                                    <div id="update-pic-form mt-2">
                                        ...
                                        <input type="hidden" id="fileContent" name="uploadedBase64Image" value='<jsp:getProperty name="food" property="foodPhoto"/>' required>
                        ...
                        <div class="mt-3">
                            ...
                            <input type="hidden" name="foodID" value='<jsp:getProperty name="food" property="foodID"/>'>
