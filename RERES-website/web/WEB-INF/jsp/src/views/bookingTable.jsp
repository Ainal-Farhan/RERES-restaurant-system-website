    ...
    <body>
        ...
        <content>
            <div class="content-container">
                <div class="container-custom bgContent p-4">
                            ...
                            <div class="col-3">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-control form-control-lg" placeholder="Time" name="timeCode" id="timeCode" required>
                                        ...
                                        <option value="14">9.00 PM - 10.00 PM</option>
                    ...
                    <div class="row">
                        <div class="col-12" style="text-align: center">
                            <%
                                if(session.getAttribute("isCheck") != null && (Boolean)session.getAttribute("isCheck")) {
                            %>
                            <h1><%= session.getAttribute("displayMessage") %></h1>
                            <% } %>
                        </div>
                    </div>
                    ...
                    <form action="BookingTableServlet" method="POST">
                        <div class="row mt-4">
                            <div class="col-lg-8" style="text-align: center">
                                <h5>This is our table layout:</h5>
                                <img src="${pageContext.servletContext.contextPath}/assets/img/bookingtable/tableLayout.png" alt="logo" style="width: inherit;" class="">
                            </div>
                            ...
                            <div class="col-lg-4 mt-4">
                                ...
                                <table class="table table-striped mt-2">
                                    <thead class="thead-dark">
                                        ...
                                        <tbody>
                                            <% 
                                                if(session.getAttribute("isCheck") != null && (Boolean)session.getAttribute("isCheck")) {
                                                    ArrayList<BookingTable> btlist = (ArrayList<BookingTable>)session.getAttribute("btlist");
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="foodOrder" value="later">Later
                                    </label>
                                </div>
                            ...
                            if(session.getAttribute("isCheck") != null && (Boolean)session.getAttribute("isCheck")) {
                            %>
                            <h3>Price: RM<%= String.format("%.2f", session.getAttribute("bookPrice")) %></h3>
                            <%
                            }
                            %>
